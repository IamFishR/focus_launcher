...
import '../services/app_launcher.dart'; // Updated import

class SelectFavoriteAppScreen extends StatefulWidget {
  const SelectFavoriteAppScreen({super.key});

  @override
  State<SelectFavoriteAppScreen> createState() =>
      _SelectFavoriteAppScreenState();
}

class _SelectFavoriteAppScreenState extends State<SelectFavoriteAppScreen> {
